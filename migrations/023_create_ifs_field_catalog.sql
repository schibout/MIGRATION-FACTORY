-- =====================================================================
-- Migration 023 : public.ifs_field_catalog — référentiel central des specs IFS
-- Une ligne = un champ d'une entité IFS d'un lot de migration.
-- Alimenté par docs/catalogIfs/spec2catalog.py depuis les classeurs Lot*.xlsx.
...
CREATE INDEX IF NOT EXISTS idx_ifs_field_catalog_lot ON public.ifs_field_catalog (lot_id);
