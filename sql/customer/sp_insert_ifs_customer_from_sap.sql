CREATE OR REPLACE PROCEDURE clean_data.sp_insert_ifs_customer_from_sap()
 LANGUAGE plpgsql
AS $procedure$
DECLARE
...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(kna1.kunnr))
        ...
        TO_DATE(kna1.erdat, 'YYYYMMDD') AS created_on,
        ...
        TO_DATE(knb1.erdat, 'YYYYMMDD') AS accounting_created_on,
        ...
        TO_DATE(knvv.erdat, 'YYYYMMDD') AS sales_created_on,
