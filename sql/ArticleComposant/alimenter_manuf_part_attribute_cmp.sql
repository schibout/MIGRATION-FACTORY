...
-- SJ et CS sont identiques : une seule regle de matrice, sans site.
--
...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(cmp.code_produit))
        ...
        public.get_matrix_value('clean_data.manuf_part_attribute', 'adjust_on_op_qty_deviation', p_contract, NULLIF(TRIM(cmp.famille), '')) as adjust_on_op_qty_deviation,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'adjust_on_op_qty_deviation_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as adjust_on_op_qty_deviation_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'auto_replace_alt_comp', p_contract, NULLIF(TRIM(cmp.famille), '')) as auto_replace_alt_comp,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'auto_replace_alt_comp_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as auto_replace_alt_comp_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'backflush_part', p_contract, NULLIF(TRIM(cmp.famille), '')) as backflush_part,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'backflush_part_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as backflush_part_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'close_tolerance', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as close_tolerance,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'component_scrap', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as component_scrap,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'configuration_usage', p_contract, NULLIF(TRIM(cmp.famille), '')) as configuration_usage,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'configuration_usage_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as configuration_usage_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'consider_lead_time', p_contract, NULLIF(TRIM(cmp.famille), '')) as consider_lead_time,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'consider_lead_time_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as consider_lead_time_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'cum_leadtime', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as cum_leadtime,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'dop_pegged_so_update_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_pegged_so_update_flag,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'dop_pegged_so_update_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_pegged_so_update_flag_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'engineering_info', p_contract, NULLIF(TRIM(cmp.famille), '')) as engineering_info,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'engineering_info_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as engineering_info_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'fixed_leadtime_day', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as fixed_leadtime_day,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'fixed_leadtime_hour', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as fixed_leadtime_hour,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'include_firm_demands', p_contract, NULLIF(TRIM(cmp.famille), '')) as include_firm_demands,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'include_firm_supplies', p_contract, NULLIF(TRIM(cmp.famille), '')) as include_firm_supplies,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_overreported_qty', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_overreported_qty,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_overreported_qty_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_overreported_qty_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_planned_scrap', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_planned_scrap,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_planned_scrap_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_planned_scrap_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_type', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_type,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'issue_type_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as issue_type_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'low_level', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as low_level,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'mrp_control_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as mrp_control_flag,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'mrp_control_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as mrp_control_flag_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'optimize_new_delivery_date', p_contract, NULLIF(TRIM(cmp.famille), '')) as optimize_new_delivery_date,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'order_gap_time', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as order_gap_time,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'over_reporting', p_contract, NULLIF(TRIM(cmp.famille), '')) as over_reporting,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'over_reporting_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as over_reporting_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'overhaul_scrap_rule', p_contract, NULLIF(TRIM(cmp.famille), '')) as overhaul_scrap_rule,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'overhaul_scrap_rule_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as overhaul_scrap_rule_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'plan_manuf_sup_on_due_date', p_contract, NULLIF(TRIM(cmp.famille), '')) as plan_manuf_sup_on_due_date,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'plan_manuf_sup_on_due_date_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as plan_manuf_sup_on_due_date_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'prod_part_as_supply_in_mrp', p_contract, NULLIF(TRIM(cmp.famille), '')) as prod_part_as_supply_in_mrp,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'prod_part_as_supply_in_mrp_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as prod_part_as_supply_in_mrp_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'promise_planned', p_contract, NULLIF(TRIM(cmp.famille), '')) as promise_planned,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'promise_planned_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as promise_planned_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'routing_effectivity', p_contract, NULLIF(TRIM(cmp.famille), '')) as routing_effectivity,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'routing_effectivity_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as routing_effectivity_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'run_crp', p_contract, NULLIF(TRIM(cmp.famille), '')) as run_crp,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'run_in_background', p_contract, NULLIF(TRIM(cmp.famille), '')) as run_in_background,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'run_mrp', p_contract, NULLIF(TRIM(cmp.famille), '')) as run_mrp,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'ship_dirty', p_contract, NULLIF(TRIM(cmp.famille), '')) as ship_dirty,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'ship_dirty_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as ship_dirty_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'shrinkage_factor', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as shrinkage_factor,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'structure_effectivity', p_contract, NULLIF(TRIM(cmp.famille), '')) as structure_effectivity,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'structure_effectivity_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as structure_effectivity_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'unprotected_lead_time', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as unprotected_lead_time,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'use_theoritical_density', p_contract, NULLIF(TRIM(cmp.famille), '')) as use_theoritical_density,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'use_theoritical_density_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as use_theoritical_density_db,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'variable_leadtime_day', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as variable_leadtime_day,
        public.get_matrix_value('clean_data.manuf_part_attribute', 'variable_leadtime_hour', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as variable_leadtime_hour
