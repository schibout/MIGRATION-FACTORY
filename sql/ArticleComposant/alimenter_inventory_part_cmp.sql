...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(cmp.code_produit))
        ...
        -- (SJ = Standard Cost / ST, CS = Weighted Average / AV) -> regles matrice par (site, famille)
        public.get_matrix_value('clean_data.inventory_part', 'inventory_valuation_method', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_valuation_method,
        public.get_matrix_value('clean_data.inventory_part', 'inventory_valuation_method_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_valuation_method_db,
        CURRENT_TIMESTAMP as create_date,
        CURRENT_TIMESTAMP as last_activity_date,
        public.get_matrix_value('clean_data.inventory_part', 'abc_class', p_contract, NULLIF(TRIM(cmp.famille), '')) as abc_class,
        public.get_matrix_value('clean_data.inventory_part', 'asset_class', p_contract, NULLIF(TRIM(cmp.famille), '')) as asset_class,
        public.get_matrix_value('clean_data.inventory_part', 'automatic_capability_check', p_contract, NULLIF(TRIM(cmp.famille), '')) as automatic_capability_check,
        public.get_matrix_value('clean_data.inventory_part', 'automatic_capability_check_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as automatic_capability_check_db,
        public.get_matrix_value('clean_data.inventory_part', 'avail_activity_status', p_contract, NULLIF(TRIM(cmp.famille), '')) as avail_activity_status,
        public.get_matrix_value('clean_data.inventory_part', 'avail_activity_status_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as avail_activity_status_db,
        public.get_matrix_value('clean_data.inventory_part', 'c_is_green', p_contract, NULLIF(TRIM(cmp.famille), '')) as c_is_green,
        public.get_matrix_value('clean_data.inventory_part', 'c_is_green_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as c_is_green_db,
        public.get_matrix_value('clean_data.inventory_part', 'co_reserve_onh_analys_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as co_reserve_onh_analys_flag,
        public.get_matrix_value('clean_data.inventory_part', 'co_reserve_onh_analys_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as co_reserve_onh_analys_flag_db,
        public.get_matrix_value('clean_data.inventory_part', 'company', p_contract, NULLIF(TRIM(cmp.famille), '')) as company,
        public.get_matrix_value('clean_data.inventory_part', 'consumption_tax', p_contract, NULLIF(TRIM(cmp.famille), '')) as consumption_tax,
        public.get_matrix_value('clean_data.inventory_part', 'consumption_tax_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as consumption_tax_db,
        public.get_matrix_value('clean_data.inventory_part', 'count_variance', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as count_variance,
        public.get_matrix_value('clean_data.inventory_part', 'cycle_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as cycle_code,
        public.get_matrix_value('clean_data.inventory_part', 'cycle_code_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as cycle_code_db,
        public.get_matrix_value('clean_data.inventory_part', 'cycle_period', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as cycle_period,
        public.get_matrix_value('clean_data.inventory_part', 'dop_connection', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_connection,
        public.get_matrix_value('clean_data.inventory_part', 'dop_connection_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_connection_db,
        public.get_matrix_value('clean_data.inventory_part', 'dop_netting', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_netting,
        public.get_matrix_value('clean_data.inventory_part', 'dop_netting_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_netting_db,
        public.get_matrix_value('clean_data.inventory_part', 'estimated_material_cost', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as estimated_material_cost,
        public.get_matrix_value('clean_data.inventory_part', 'excl_ship_pack_proposal', p_contract, NULLIF(TRIM(cmp.famille), '')) as excl_ship_pack_proposal,
        public.get_matrix_value('clean_data.inventory_part', 'excl_ship_pack_proposal_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as excl_ship_pack_proposal_db,
        public.get_matrix_value('clean_data.inventory_part', 'expected_leadtime', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as expected_leadtime,
        public.get_matrix_value('clean_data.inventory_part', 'ext_service_cost_method', p_contract, NULLIF(TRIM(cmp.famille), '')) as ext_service_cost_method,
        public.get_matrix_value('clean_data.inventory_part', 'ext_service_cost_method_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as ext_service_cost_method_db,
        public.get_matrix_value('clean_data.inventory_part', 'forecast_consumption_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as forecast_consumption_flag,
        public.get_matrix_value('clean_data.inventory_part', 'forecast_consumption_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as forecast_consumption_flag_db,
        public.get_matrix_value('clean_data.inventory_part', 'frequency_class', p_contract, NULLIF(TRIM(cmp.famille), '')) as frequency_class,
        public.get_matrix_value('clean_data.inventory_part', 'frequency_class_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as frequency_class_db,
        public.get_matrix_value('clean_data.inventory_part', 'inventory_part_cost_level', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_part_cost_level,
        public.get_matrix_value('clean_data.inventory_part', 'inventory_part_cost_level_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_part_cost_level_db,
        public.get_matrix_value('clean_data.inventory_part', 'invoice_consideration', p_contract, NULLIF(TRIM(cmp.famille), '')) as invoice_consideration,
        public.get_matrix_value('clean_data.inventory_part', 'invoice_consideration_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as invoice_consideration_db,
        public.get_matrix_value('clean_data.inventory_part', 'lead_time_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as lead_time_code,
        public.get_matrix_value('clean_data.inventory_part', 'lead_time_code_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as lead_time_code_db,
        public.get_matrix_value('clean_data.inventory_part', 'lifecycle_stage', p_contract, NULLIF(TRIM(cmp.famille), '')) as lifecycle_stage,
        public.get_matrix_value('clean_data.inventory_part', 'lifecycle_stage_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as lifecycle_stage_db,
        public.get_matrix_value('clean_data.inventory_part', 'mandatory_expiration_date', p_contract, NULLIF(TRIM(cmp.famille), '')) as mandatory_expiration_date,
        public.get_matrix_value('clean_data.inventory_part', 'mandatory_expiration_date_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as mandatory_expiration_date_db,
        public.get_matrix_value('clean_data.inventory_part', 'manuf_leadtime', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as manuf_leadtime,
        public.get_matrix_value('clean_data.inventory_part', 'min_durab_days_co_deliv', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as min_durab_days_co_deliv,
        public.get_matrix_value('clean_data.inventory_part', 'min_durab_days_planning', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as min_durab_days_planning,
        public.get_matrix_value('clean_data.inventory_part', 'negative_on_hand', p_contract, NULLIF(TRIM(cmp.famille), '')) as negative_on_hand,
        public.get_matrix_value('clean_data.inventory_part', 'negative_on_hand_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as negative_on_hand_db,
        public.get_matrix_value('clean_data.inventory_part', 'oe_alloc_assign_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as oe_alloc_assign_flag,
        public.get_matrix_value('clean_data.inventory_part', 'oe_alloc_assign_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as oe_alloc_assign_flag_db,
        public.get_matrix_value('clean_data.inventory_part', 'onhand_analysis_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as onhand_analysis_flag,
        public.get_matrix_value('clean_data.inventory_part', 'onhand_analysis_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as onhand_analysis_flag_db,
        public.get_matrix_value('clean_data.inventory_part', 'part_catalog_configurable', p_contract, NULLIF(TRIM(cmp.famille), '')) as part_catalog_configurable,
        public.get_matrix_value('clean_data.inventory_part', 'part_catalog_configurable_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as part_catalog_configurable_db,
        public.get_matrix_value('clean_data.inventory_part', 'part_catalog_std_name_id', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as part_catalog_std_name_id,
        public.get_matrix_value('clean_data.inventory_part', 'part_status', p_contract, NULLIF(TRIM(cmp.famille), '')) as part_status,
        public.get_matrix_value('clean_data.inventory_part', 'planner_buyer', p_contract, NULLIF(TRIM(cmp.famille), '')) as planner_buyer,
        public.get_matrix_value('clean_data.inventory_part', 'purch_leadtime', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as purch_leadtime,
        public.get_matrix_value('clean_data.inventory_part', 'qty_calc_rounding', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as qty_calc_rounding,
        public.get_matrix_value('clean_data.inventory_part', 'reset_config_std_cost', p_contract, NULLIF(TRIM(cmp.famille), '')) as reset_config_std_cost,
        public.get_matrix_value('clean_data.inventory_part', 'reset_config_std_cost_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as reset_config_std_cost_db,
        public.get_matrix_value('clean_data.inventory_part', 'shortage_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as shortage_flag,
        public.get_matrix_value('clean_data.inventory_part', 'shortage_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as shortage_flag_db,
        public.get_matrix_value('clean_data.inventory_part', 'stock_management', p_contract, NULLIF(TRIM(cmp.famille), '')) as stock_management,
        public.get_matrix_value('clean_data.inventory_part', 'stock_management_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as stock_management_db,
        public.get_matrix_value('clean_data.inventory_part', 'supply_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as supply_code,
        public.get_matrix_value('clean_data.inventory_part', 'supply_code_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as supply_code_db,
        public.get_matrix_value('clean_data.inventory_part', 'tax_manuf_equivalent', p_contract, NULLIF(TRIM(cmp.famille), '')) as tax_manuf_equivalent,
        public.get_matrix_value('clean_data.inventory_part', 'tax_manuf_equivalent_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as tax_manuf_equivalent_db,
        public.get_matrix_value('clean_data.inventory_part', 'type_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as type_code,
        public.get_matrix_value('clean_data.inventory_part', 'type_code_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as type_code_db
