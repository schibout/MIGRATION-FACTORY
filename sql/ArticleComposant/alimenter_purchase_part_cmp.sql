...
-- Les lignes SJ et CS du gabarit sont identiques : une seule regle, sans site.
--
...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(cmp.code_produit))
        ...
        public.get_matrix_value('clean_data.purchase_part', 'acquisition_type', p_contract, NULLIF(TRIM(cmp.famille), '')) as acquisition_type,
        public.get_matrix_value('clean_data.purchase_part', 'acquisition_type_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as acquisition_type_db,
        public.get_matrix_value('clean_data.purchase_part', 'action_authorized', p_contract, NULLIF(TRIM(cmp.famille), '')) as action_authorized,
        public.get_matrix_value('clean_data.purchase_part', 'action_authorized_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as action_authorized_db,
        public.get_matrix_value('clean_data.purchase_part', 'action_non_authorized', p_contract, NULLIF(TRIM(cmp.famille), '')) as action_non_authorized,
        public.get_matrix_value('clean_data.purchase_part', 'action_non_authorized_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as action_non_authorized_db,
        public.get_matrix_value('clean_data.purchase_part', 'close_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as close_code,
        public.get_matrix_value('clean_data.purchase_part', 'close_code_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as close_code_db,
        public.get_matrix_value('clean_data.purchase_part', 'close_tolerance', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as close_tolerance,
        public.get_matrix_value('clean_data.purchase_part', 'company', p_contract, NULLIF(TRIM(cmp.famille), '')) as company,
        public.get_matrix_value('clean_data.purchase_part', 'dop_pegged_po_update_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_pegged_po_update_flag,
        public.get_matrix_value('clean_data.purchase_part', 'dop_pegged_po_update_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as dop_pegged_po_update_flag_db,
        public.get_matrix_value('clean_data.purchase_part', 'external_resource', p_contract, NULLIF(TRIM(cmp.famille), '')) as external_resource,
        public.get_matrix_value('clean_data.purchase_part', 'external_resource_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as external_resource_db,
        public.get_matrix_value('clean_data.purchase_part', 'inventory_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_flag,
        public.get_matrix_value('clean_data.purchase_part', 'inventory_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as inventory_flag_db,
        public.get_matrix_value('clean_data.purchase_part', 'package_part_flag', p_contract, NULLIF(TRIM(cmp.famille), '')) as package_part_flag,
        public.get_matrix_value('clean_data.purchase_part', 'package_part_flag_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as package_part_flag_db,
        public.get_matrix_value('clean_data.purchase_part', 'qualified_manufacturer', p_contract, NULLIF(TRIM(cmp.famille), '')) as qualified_manufacturer,
        public.get_matrix_value('clean_data.purchase_part', 'qualified_manufacturer_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as qualified_manufacturer_db,
        public.get_matrix_value('clean_data.purchase_part', 'qualified_supplier', p_contract, NULLIF(TRIM(cmp.famille), '')) as qualified_supplier,
        public.get_matrix_value('clean_data.purchase_part', 'qualified_supplier_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as qualified_supplier_db,
        public.get_matrix_value('clean_data.purchase_part', 'standard_pack_size', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as standard_pack_size,
        public.get_matrix_value('clean_data.purchase_part', 'std_name_description', p_contract, NULLIF(TRIM(cmp.famille), '')) as std_name_description,
        public.get_matrix_value('clean_data.purchase_part', 'std_name_id', p_contract, NULLIF(TRIM(cmp.famille), '')) as std_name_id,
        public.get_matrix_value('clean_data.purchase_part', 'taxable', p_contract, NULLIF(TRIM(cmp.famille), '')) as taxable,
        public.get_matrix_value('clean_data.purchase_part', 'taxable_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as taxable_db
