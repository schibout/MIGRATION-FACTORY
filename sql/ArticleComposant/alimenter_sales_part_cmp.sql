...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(cmp.code_produit))
        ...
        public.get_matrix_value('clean_data.sales_part', 'activeind', p_contract, NULLIF(TRIM(cmp.famille), '')) as activeind,
        public.get_matrix_value('clean_data.sales_part', 'activeind_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as activeind_db,
        public.get_matrix_value('clean_data.sales_part', 'allow_inc_pkg_rsrv_picklst', p_contract, NULLIF(TRIM(cmp.famille), '')) as allow_inc_pkg_rsrv_picklst,
        public.get_matrix_value('clean_data.sales_part', 'allow_incomp_pkg_delivery', p_contract, NULLIF(TRIM(cmp.famille), '')) as allow_incomp_pkg_delivery,
        public.get_matrix_value('clean_data.sales_part', 'catalog_group', p_contract, NULLIF(TRIM(cmp.famille), '')) as catalog_group,
        public.get_matrix_value('clean_data.sales_part', 'catalog_type', p_contract, NULLIF(TRIM(cmp.famille), '')) as catalog_type,
        public.get_matrix_value('clean_data.sales_part', 'catalog_type_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as catalog_type_db,
        public.get_matrix_value('clean_data.sales_part', 'close_tolerance', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as close_tolerance,
        public.get_matrix_value('clean_data.sales_part', 'conv_factor', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as conv_factor,
        public.get_matrix_value('clean_data.sales_part', 'country_of_origin', p_contract, NULLIF(TRIM(cmp.famille), '')) as country_of_origin,
        public.get_matrix_value('clean_data.sales_part', 'create_sm_object_option', p_contract, NULLIF(TRIM(cmp.famille), '')) as create_sm_object_option,
        public.get_matrix_value('clean_data.sales_part', 'create_sm_object_option_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as create_sm_object_option_db,
        public.get_matrix_value('clean_data.sales_part', 'export_to_external_app', p_contract, NULLIF(TRIM(cmp.famille), '')) as export_to_external_app,
        public.get_matrix_value('clean_data.sales_part', 'export_to_external_app_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as export_to_external_app_db,
        public.get_matrix_value('clean_data.sales_part', 'inverted_conv_factor', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as inverted_conv_factor,
        public.get_matrix_value('clean_data.sales_part', 'list_price', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as list_price,
        public.get_matrix_value('clean_data.sales_part', 'list_price_incl_tax', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as list_price_incl_tax,
        public.get_matrix_value('clean_data.sales_part', 'non_inv_part_type', p_contract, NULLIF(TRIM(cmp.famille), '')) as non_inv_part_type,
        public.get_matrix_value('clean_data.sales_part', 'non_inv_part_type_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as non_inv_part_type_db,
        public.get_matrix_value('clean_data.sales_part', 'pack_comp_in_shpmnt', p_contract, NULLIF(TRIM(cmp.famille), '')) as pack_comp_in_shpmnt,
        public.get_matrix_value('clean_data.sales_part', 'price_conv_factor', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as price_conv_factor,
        public.get_matrix_value('clean_data.sales_part', 'primary_catalog', p_contract, NULLIF(TRIM(cmp.famille), '')) as primary_catalog,
        public.get_matrix_value('clean_data.sales_part', 'primary_catalog_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as primary_catalog_db,
        public.get_matrix_value('clean_data.sales_part', 'quick_registered_part', p_contract, NULLIF(TRIM(cmp.famille), '')) as quick_registered_part,
        public.get_matrix_value('clean_data.sales_part', 'quick_registered_part_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as quick_registered_part_db,
        public.get_matrix_value('clean_data.sales_part', 'rental_list_price', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as rental_list_price,
        public.get_matrix_value('clean_data.sales_part', 'rental_list_price_incl_tax', p_contract, NULLIF(TRIM(cmp.famille), ''))::numeric as rental_list_price_incl_tax,
        public.get_matrix_value('clean_data.sales_part', 'sales_price_group_id', p_contract, NULLIF(TRIM(cmp.famille), '')) as sales_price_group_id,
        public.get_matrix_value('clean_data.sales_part', 'sales_type', p_contract, NULLIF(TRIM(cmp.famille), '')) as sales_type,
        public.get_matrix_value('clean_data.sales_part', 'sales_type_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as sales_type_db,
        public.get_matrix_value('clean_data.sales_part', 'sourcing_option', p_contract, NULLIF(TRIM(cmp.famille), '')) as sourcing_option,
        public.get_matrix_value('clean_data.sales_part', 'sourcing_option_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as sourcing_option_db,
        public.get_matrix_value('clean_data.sales_part', 'tax_code', p_contract, NULLIF(TRIM(cmp.famille), '')) as tax_code,
        public.get_matrix_value('clean_data.sales_part', 'taxable', p_contract, NULLIF(TRIM(cmp.famille), '')) as taxable,
        public.get_matrix_value('clean_data.sales_part', 'taxable_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as taxable_db,
        public.get_matrix_value('clean_data.sales_part', 'use_price_incl_tax', p_contract, NULLIF(TRIM(cmp.famille), '')) as use_price_incl_tax,
        public.get_matrix_value('clean_data.sales_part', 'use_price_incl_tax_db', p_contract, NULLIF(TRIM(cmp.famille), '')) as use_price_incl_tax_db
