...
BEGIN
    ...
    SELECT DISTINCT ON (fc.customer_id, fc.address_id, public.get_transcodification('COUNTRY', COALESCE(k.LAND1, fc.country, 'FR')))
        ...
        public.get_default_value('clean_data.customer_delivery_fee_code', 'company') as company,
        ...
        public.get_default_value('clean_data.customer_delivery_fee_code', 'tax_code_selection') as tax_code_selection
    FROM fc
