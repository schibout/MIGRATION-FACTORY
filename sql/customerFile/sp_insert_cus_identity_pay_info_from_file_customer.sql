...
BEGIN
    ...
    SELECT DISTINCT ON (fc.bukrs, fc.customer_id)
        ...
        public.get_default_value('clean_data.cus_identity_pay_info', 'reminder_template', '1', 'CUSTOMERFILE') as reminder_template,   -- champ obligatoire dans IFS
        ...
        public.get_default_value('clean_data.cus_identity_pay_info', 'payment_receipt_type', 'No Receipt', 'CUSTOMERFILE') as payment_receipt_type,
        public.get_default_value('clean_data.cus_identity_pay_info', 'payment_receipt_type_db', 'NO_RECEIPT', 'CUSTOMERFILE') as payment_receipt_type_db,
