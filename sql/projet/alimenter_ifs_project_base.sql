...
BEGIN
    ...
    SELECT 
        ...
        -- PROGRAM_ID: CAPEX
        public.get_default_value('clean_data.project_base', 'program_id') as program_id,
        ...
        -- CATEGORY2_ID: MECA
        public.get_default_value('clean_data.project_base', 'category2_id') as category2_id,
        ...
        public.get_default_value('clean_data.project_base', 'baseline_revision_number') as baseline_revision_number,
        
        -- EARNED_VALUE_METHOD: 'Planned' par défaut (OBLIGATOIRE)
        public.get_default_value('clean_data.project_base', 'earned_value_method') as earned_value_method,
        ...
        public.get_default_value('clean_data.project_base', 'material_allocation') as material_allocation,
        ...
        public.get_default_value('clean_data.project_base', 'multi_currency_budgeting') as multi_currency_budgeting,
        ...
        public.get_default_value('clean_data.project_base', 'project_misc_comp_method') as project_misc_comp_method,
        ...
        public.get_default_value('clean_data.project_base', 'work_day_to_hours_conv')::numeric as work_day_to_hours_conv
