...
BEGIN
    ...
    SELECT
        ...
        public.get_default_value('clean_data.activity', 'sub_project_id', '10') AS sub_project_id,
        public.get_default_value('clean_data.activity', 'progress_method', 'ALL_CONNECTED_OBJECTS') AS progress_method,
        public.get_default_value('clean_data.activity', 'progress_method_db', 'ALL_CONNECTED_OBJECTS') AS progress_method_db,
        public.get_default_value('clean_data.activity', 'planned_cost_driver', 'CONNECTED_OBJECTS') AS planned_cost_driver,
        public.get_default_value('clean_data.activity', 'planned_cost_driver_db', 'CONNECTED_OBJECTS') AS planned_cost_driver_db,
        public.get_default_value('clean_data.activity', 'exclude_periodical_cap', 'INCLUDE') AS exclude_periodical_cap,
        public.get_default_value('clean_data.activity', 'exclude_periodical_cap_db', 'INCLUDE') AS exclude_periodical_cap_db,
        public.get_default_value('clean_data.activity', 'exclude_resource_progress', 'FALSE') AS exclude_resource_progress,
        public.get_default_value('clean_data.activity', 'exclude_resource_progress_db', 'FALSE') AS exclude_resource_progress_db,
        public.get_default_value('clean_data.activity', 'exclude_from_integrations', 'FALSE') AS exclude_from_integrations,
        public.get_default_value('clean_data.activity', 'exclude_from_integrations_db', 'FALSE') AS exclude_from_integrations_db,
        public.get_default_value('clean_data.activity', 'node_type', 'ACTIVITY') AS node_type,
        public.get_default_value('clean_data.activity', 'node_type_db', 'ACTIVITY') AS node_type_db,
        public.get_default_value('clean_data.activity', 'mandatory_invoice_comment', 'INHERIT') AS mandatory_invoice_comment,
        public.get_default_value('clean_data.activity', 'mandatory_invoice_comment_db', 'INHERIT') AS mandatory_invoice_comment_db,
