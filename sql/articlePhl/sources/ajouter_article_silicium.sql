...
BEGIN
    ...
    SELECT
        ...
        public.get_default_value('clean_data.part_catalog', 'lot_tracking_code_db')        as lot_tracking_code_db,
    ...
    SELECT
        ...
        public.get_default_value('clean_data.inventory_part', 'type_code_db', 'SILICIUM') as type_code_db,  -- article achete (PART TYPE = 3)
        ...
        public.get_default_value('clean_data.inventory_part', 'lead_time_code_db', 'SILICIUM') as lead_time_code_db,  -- article achete (LEAD TIME CODE = P)
        ...
        public.get_default_value('clean_data.inventory_part', 'zero_cost_flag_db', 'SILICIUM') as zero_cost_flag_db,  -- article achete (ZERO COST FLAG = N)
