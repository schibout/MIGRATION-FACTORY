...
BEGIN
    ...
    SELECT DISTINCT ON (TRIM(phl."N. ARTICLE"))
        ...
        public.get_default_value('clean_data.sales_part', 'catalog_type_db', 'INV') as catalog_type_db,
        ...
        public.get_default_value('clean_data.sales_part', 'non_inv_part_type_db', NULL) as non_inv_part_type_db,
        public.get_default_value('clean_data.sales_part', 'customs_stat_no', NULL) as customs_stat_no,
