...
BEGIN
    ...
    SELECT 
        ...
        public.get_default_value('clean_data.payment_way_per_identity', 'party_type', 'Supplier') as party_type,
        public.get_default_value('clean_data.payment_way_per_identity', 'party_type_db', 'SUPPLIER') as party_type_db,
        public.get_default_value('clean_data.payment_way_per_identity', 'way_id', 1) as way_id,
