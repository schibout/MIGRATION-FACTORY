...
BEGIN
    ...
    SELECT DISTINCT
        ...
        public.get_default_value('clean_data.identity_invoice_info', 'party_type', 'Supplier') as PARTY_TYPE,
        public.get_default_value('clean_data.identity_invoice_info', 'party_type_db', 'SUPPLIER') as PARTY_TYPE_DB,
        ...
        public.get_default_value('clean_data.identity_invoice_info', 'ncf_reference_check', 'FALSE') as NCF_REFERENCE_CHECK,
        public.get_default_value('clean_data.identity_invoice_info', 'tax_exempt', 'FALSE') as TAX_EXEMPT,
        public.get_default_value('clean_data.identity_invoice_info', 'second_tin', 'FALSE') as SECOND_TIN,
        public.get_default_value('clean_data.identity_invoice_info', 'report_and_withhold', 'FALSE') as REPORT_AND_WITHHOLD,
        public.get_default_value('clean_data.identity_invoice_info', 'print_tax_code_text', 'FALSE') as PRINT_TAX_CODE_TEXT,
        public.get_default_value('clean_data.identity_invoice_info', 'withholding_base_amount', 'FALSE') as WITHHOLDING_BASE_AMOUNT,
        public.get_default_value('clean_data.identity_invoice_info', 'matching_level', 'FALSE') as MATCHING_LEVEL,
        public.get_default_value('clean_data.identity_invoice_info', 'allow_tolerance', 'TRUE') as ALLOW_TOLERANCE,
        public.get_default_value('clean_data.identity_invoice_info', 'create_tolerance_posting', 'FALSE') as CREATE_TOLERANCE_POSTING,
        public.get_default_value('clean_data.identity_invoice_info', 'allow_quantity_diff', 'TRUE') as ALLOW_QUANTITY_DIFF,
        public.get_default_value('clean_data.identity_invoice_info', 'tax_certificate_form', 'FALSE') as TAX_CERTIFICATE_FORM,
        public.get_default_value('clean_data.identity_invoice_info', 'legal_identity', 'FALSE') as LEGAL_IDENTITY,
        public.get_default_value('clean_data.identity_invoice_info', 'po_ref_rec_ref_val_method', 'FALSE') as PO_REF_REC_REF_VAL_METHOD,
        CURRENT_TIMESTAMP as BI_TIMESTAMP,
        public.get_default_value('clean_data.identity_invoice_info', 'invoice_recipient_from', 'FALSE') as INVOICE_RECIPIENT_FROM,
        public.get_default_value('clean_data.identity_invoice_info', 'exc_from_spesometro_dec', 'FALSE') as EXC_FROM_SPESOMETRO_DEC,
        public.get_default_value('clean_data.identity_invoice_info', 'service_code_required', 'FALSE') as SERVICE_CODE_REQUIRED,
        public.get_default_value('clean_data.identity_invoice_info', 'inc_inv_curr_rate_base', 'FALSE') as INC_INV_CURR_RATE_BASE,
        public.get_default_value('clean_data.identity_invoice_info', 'tax_buy_curr_rate_base', 'FALSE') as TAX_BUY_CURR_RATE_BASE,
        public.get_default_value('clean_data.identity_invoice_info', 'exclude_posting_auth', 'FALSE') as EXCLUDE_POSTING_AUTH,
        public.get_default_value('clean_data.identity_invoice_info', 'exclude_invoice_image', 'FALSE') as EXCLUDE_INVOICE_IMAGE,
        public.get_default_value('clean_data.identity_invoice_info', 'utility_bill_provider', 'FALSE') as UTILITY_BILL_PROVIDER,
        public.get_default_value('clean_data.identity_invoice_info', 'digital_invoice', 'FALSE') as DIGITAL_INVOICE,
        CASE 
