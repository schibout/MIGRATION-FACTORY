...
procedures=(
    "sp_insert_customer_info_from_client_phl"
    "sp_insert_customer_info_address_from_client_adresse_phl"
    "sp_insert_customer_address_type_from_client_adresse_phl"
    "sp_insert_cus_comm_method_from_client_phl"
    "sp_insert_customer_tax_info_from_client_adresse_phl"
    "sp_insert_customer_delivery_tax_info_from_client_adresse_phl"
    "sp_insert_customer_delivery_fee_code_from_client_adresse_phl"
    "sp_insert_customer_document_tax_info_from_client_adresse_phl"
    "sp_insert_customer_tax_free_tax_code_from_client_adresse_phl"
    "sp_insert_customer_addr_tax_number_from_client_adresse_phl"
    "sp_insert_customer_del_tax_exempt_from_client_adresse_phl"
    "sp_insert_cus_ident_invoice_info_from_client_phl"
    "sp_insert_cus_identity_pay_info_from_client_phl"
    "sp_insert_cus_paym_way_per_ident_from_client_phl"
    "sp_insert_cus_payment_address_from_client_adresse_phl"
    "sp_insert_payment_way_per_identity_from_client_phl"
    "sp_insert_customer_credit_info_from_client_phl"
    "sp_insert_cust_ord_customer_from_client_phl"
