...
BEGIN
    ...
    SELECT DISTINCT ON (cp.customer_id, cap.address_id)
        ...
        public.get_default_value('clean_data.cust_ord_customer_address', 'delivery_terms', 'EXW') as delivery_terms,
        public.get_default_value('clean_data.cust_ord_customer_address', 'district_code', NULL) as district_code,
        cap.state as region_code,
        public.get_default_value('clean_data.cust_ord_customer_address', 'ship_via_code', '01') as ship_via_code,
        ...
        public.get_default_value('clean_data.cust_ord_customer_address', 'intrastat_exempt', NULL, 'CUSTOMER_PHL') as intrastat_exempt,
        public.get_default_value('clean_data.cust_ord_customer_address', 'intrastat_exempt_db', 'FALSE', 'CUSTOMER_PHL') as intrastat_exempt_db,
        ...
        public.get_default_value('clean_data.cust_ord_customer_address', 'del_terms_location', NULL) as del_terms_location,
