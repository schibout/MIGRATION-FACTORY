...
BEGIN
    ...
    SELECT DISTINCT ON (cap.customer_id, cap.address_id)
        ...
        public.get_default_value('clean_data.customer_info_address', 'valid_from', NULL)::date as valid_from,
        public.get_default_value('clean_data.customer_info_address', 'valid_to', NULL)::date as valid_to,
        cap.party as party,
        cap.address_lov as address_lov,
        public.get_default_value('clean_data.customer_info_address', 'default_domain', NULL) as default_domain,
