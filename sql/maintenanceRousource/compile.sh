...
# Script de compilation des procédures stockées MAINTENANCE RESOURCE
...
# Début du script
echo "=========================================="
echo "  Compilation des procédures MAINTENANCE RESOURCE"
echo "=========================================="
echo ""
...
# L'ordre est important: find_person_id doit être compilé en premier (dépendance)
files=(
    "00_find_person_id.sql"
