...
BEGIN
    ...
    SELECT DISTINCT ON (r.mandt, r.rsnum, r.rspos)
        ...
        r.bdmng AS plan_qty,
        public.get_default_value('clean_data.maint_material_req_line', 'qty', NULL)::numeric AS qty,
        public.get_default_value('clean_data.maint_material_req_line', 'qty_short', NULL)::numeric AS qty_short,
        public.get_default_value('clean_data.maint_material_req_line', 'qty_assigned', NULL)::numeric AS qty_assigned,
        public.get_default_value('clean_data.maint_material_req_line', 'qty_returned', NULL)::numeric AS qty_returned,
        ...
        public.get_default_value('clean_data.maint_material_req_line', 'catalog_no', NULL) AS catalog_no,
        public.get_default_value('clean_data.maint_material_req_line', 'price_list_no', NULL) AS price_list_no,
        public.get_default_value('clean_data.maint_material_req_line', 'list_price', NULL)::numeric AS list_price,
        public.get_default_value('clean_data.maint_material_req_line', 'list_price_curr', NULL)::numeric AS list_price_curr,
        public.get_default_value('clean_data.maint_material_req_line', 'sale_unit_price', NULL)::numeric AS sale_unit_price,
        public.get_default_value('clean_data.maint_material_req_line', 'sale_unit_price_curr', NULL)::numeric AS sale_unit_price_curr,
        public.get_default_value('clean_data.maint_material_req_line', 'discount', NULL)::numeric AS discount,
        public.get_default_value('clean_data.maint_material_req_line', 'qty_to_invoice', NULL)::numeric AS qty_to_invoice,
        ...
        public.get_default_value('clean_data.maint_material_req_line', 'task_plan_line_seq', NULL)::numeric AS task_plan_line_seq,
        substring(nullif(trim(r.sernr),''),1,50) AS serial_no,
        public.get_default_value('clean_data.maint_material_req_line', 'condition_code', NULL) AS condition_code,
        public.get_default_value('clean_data.maint_material_req_line', 'part_ownership', NULL) AS part_ownership,
        public.get_default_value('clean_data.maint_material_req_line', 'part_ownership_db', 'COMPANY OWNED') AS part_ownership_db,
        public.get_default_value('clean_data.maint_material_req_line', 'owner', NULL) AS owner,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_code', NULL) AS supply_code,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_code_db', 'INVENT_ORDER') AS supply_code_db,
        public.get_default_value('clean_data.maint_material_req_line', 'job_id', NULL)::numeric AS job_id,
        public.get_default_value('clean_data.maint_material_req_line', 'is_closed', NULL)::numeric AS is_closed,
        public.get_default_value('clean_data.maint_material_req_line', 'pegged_qty', NULL)::numeric AS pegged_qty,
        public.get_default_value('clean_data.maint_material_req_line', 'repair_part_flag', NULL) AS repair_part_flag,
        public.get_default_value('clean_data.maint_material_req_line', 'manual_line', NULL) AS manual_line,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_equip_object_seq', NULL)::numeric AS rwo_equip_object_seq,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_mch_contract', NULL) AS rwo_mch_contract,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_mch_code', NULL) AS rwo_mch_code,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_contract', NULL) AS rwo_contract,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_org_code', NULL) AS rwo_org_code,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_lot_batch_no', NULL) AS rwo_lot_batch_no,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_err_descr', NULL) AS rwo_err_descr,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_copy_prepost', NULL) AS rwo_copy_prepost,
        public.get_default_value('clean_data.maint_material_req_line', 'rwo_copy_prepost_db', NULL) AS rwo_copy_prepost_db,
        public.get_default_value('clean_data.maint_material_req_line', 'price_source_db', NULL) AS price_source_db,
        public.get_default_value('clean_data.maint_material_req_line', 'price_source_id', NULL) AS price_source_id,
        public.get_default_value('clean_data.maint_material_req_line', 'generated', NULL) AS generated,
        public.get_default_value('clean_data.maint_material_req_line', 'markup', NULL)::numeric AS markup,
        public.get_default_value('clean_data.maint_material_req_line', 'rental', NULL) AS rental,
        public.get_default_value('clean_data.maint_material_req_line', 'rental_db', NULL) AS rental_db,
        public.get_default_value('clean_data.maint_material_req_line', 'rental_task_res_seq', NULL)::numeric AS rental_task_res_seq,
        public.get_default_value('clean_data.maint_material_req_line', 'price_effective_date', NULL)::timestamp AS price_effective_date,
        public.get_default_value('clean_data.maint_material_req_line', 'quotation_no', NULL) AS quotation_no,
        public.get_default_value('clean_data.maint_material_req_line', 'quotation_rev', NULL)::numeric AS quotation_rev,
        public.get_default_value('clean_data.maint_material_req_line', 'wo_quo_no', NULL)::numeric AS wo_quo_no,
        public.get_default_value('clean_data.maint_material_req_line', 'quo_spare_seq', NULL)::numeric AS quo_spare_seq,
        public.get_default_value('clean_data.maint_material_req_line', 'change_reason', NULL) AS change_reason,
        public.get_default_value('clean_data.maint_material_req_line', 'changes_line_item_no', NULL)::numeric AS changes_line_item_no,
        public.get_default_value('clean_data.maint_material_req_line', 'qty_changed', NULL)::numeric AS qty_changed,
        ...
        public.get_default_value('clean_data.maint_material_req_line', 'quo_task_seq', NULL)::numeric AS quo_task_seq,
        public.get_default_value('clean_data.maint_material_req_line', 'tool_fac_row_no', NULL)::numeric AS tool_fac_row_no,
        public.get_default_value('clean_data.maint_material_req_line', 'place_in_facility_db', NULL) AS place_in_facility_db,
        public.get_default_value('clean_data.maint_material_req_line', 'swap_part_db', NULL) AS swap_part_db,
        public.get_default_value('clean_data.maint_material_req_line', 'serial_in', NULL) AS serial_in,
        public.get_default_value('clean_data.maint_material_req_line', 'serial_in_contract', NULL) AS serial_in_contract,
        substring(nullif(trim(r.lifnr),''),1,20) AS vendor_no,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref1', NULL) AS supply_source_ref1,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref2', NULL) AS supply_source_ref2,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref3', NULL) AS supply_source_ref3,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref4', NULL) AS supply_source_ref4,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref_state', NULL) AS supply_source_ref_state,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref_type', NULL) AS supply_source_ref_type,
        public.get_default_value('clean_data.maint_material_req_line', 'supply_source_ref_type_db', NULL) AS supply_source_ref_type_db,
        public.get_default_value('clean_data.maint_material_req_line', 'delivery', NULL) AS delivery,
        public.get_default_value('clean_data.maint_material_req_line', 'delivery_db', NULL) AS delivery_db,
        public.get_default_value('clean_data.maint_material_req_line', 'part_type', NULL) AS part_type,
        public.get_default_value('clean_data.maint_material_req_line', 'part_type_db', NULL) AS part_type_db,
        public.get_default_value('clean_data.maint_material_req_line', 'mobile_created', NULL) AS mobile_created,
        public.get_default_value('clean_data.maint_material_req_line', 'mobile_created_db', NULL) AS mobile_created_db,
        substring(md5('RESB_'||coalesce(trim(r.mandt),'')||'_'||coalesce(trim(r.rsnum),'')||'_'||coalesce(trim(r.rspos),'')),1,10) AS objid,
        public.get_default_value('clean_data.maint_material_req_line', 'objversion', '1') AS objversion,
        public.get_default_value('clean_data.maint_material_req_line', 'cf_alt_on_hand_qty', NULL)::numeric AS cf_alt_on_hand_qty,
        public.get_default_value('clean_data.maint_material_req_line', 'cf_ecartqtedispo', NULL)::numeric AS cf_ecartqtedispo,
        public.get_default_value('clean_data.maint_material_req_line', 'cf_on_supply_qty', NULL)::numeric AS cf_on_supply_qty,
        public.get_default_value('clean_data.maint_material_req_line', 'no_part_description', NULL) AS no_part_description,
        public.get_default_value('clean_data.maint_material_req_line', 'buy_unit_meas', NULL) AS buy_unit_meas,
        public.get_default_value('clean_data.maint_material_req_line', 'pickup_task_id', NULL)::numeric AS pickup_task_id,
        public.get_default_value('clean_data.maint_material_req_line', 'consumed_qty', NULL)::numeric AS consumed_qty,
        public.get_default_value('clean_data.maint_material_req_line', 'fbuy_unit_price', NULL)::numeric AS fbuy_unit_price,
        public.get_default_value('clean_data.maint_material_req_line', 'external_id', NULL) AS external_id,
        public.get_default_value('clean_data.maint_material_req_line', 'sender_type', NULL) AS sender_type,
        public.get_default_value('clean_data.maint_material_req_line', 'sender_type_db', NULL) AS sender_type_db,
        public.get_default_value('clean_data.maint_material_req_line', 'sender_id', NULL) AS sender_id,
        ...
        public.get_default_value('clean_data.maint_material_req_line', 'mobile_warranty', NULL) AS mobile_warranty,
        public.get_default_value('clean_data.maint_material_req_line', 'mobile_warranty_db', NULL) AS mobile_warranty_db,
        public.get_default_value('clean_data.maint_material_req_line', 'purchase_method', NULL) AS purchase_method,
        public.get_default_value('clean_data.maint_material_req_line', 'purchase_method_db', NULL) AS purchase_method_db,
        public.get_default_value('clean_data.maint_material_req_line', 'service_type', NULL) AS service_type,
