...
BEGIN
    ...
    WITH afru_last_op AS (
        ...
        SELECT
            ...
            public.get_default_value('clean_data.jt_task', 'company', 'TRIM') AS company,
            ...
            public.get_default_value('clean_data.jt_task', 'fixed_start', NULL)::timestamp AS fixed_start,
            public.get_default_value('clean_data.jt_task', 'exclude_from_scheduling', 'False') AS exclude_from_scheduling,
            public.get_default_value('clean_data.jt_task', 'exclude_from_scheduling_db', 'FALSE') AS exclude_from_scheduling_db,
            public.get_default_value('clean_data.jt_task', 'adjusted_duration', 'FALSE') AS adjusted_duration,
            ...
            public.get_default_value('clean_data.jt_task', 'appointment_required', 'FALSE') AS appointment_required,
            public.get_default_value('clean_data.jt_task', 'remotely_fulfilled', 'FALSE') AS remotely_fulfilled,
            public.get_default_value('clean_data.jt_task', 'scheduled_manually', 'FALSE') AS scheduled_manually,
            SUBSTRING(NULLIF(TRIM(active_status), ''), 1, 4000) AS state,
            public.get_default_value('clean_data.jt_task', 'objtype', 'JtTask') AS objtype,
            public.get_default_value('clean_data.jt_task', 'objversion', '1') AS objversion,
