...
BEGIN
    ...
    WITH afru_last_op AS (
        ...
        SELECT
            ...
            NULL::timestamp AS fixed_start,
            'False' AS exclude_from_scheduling,
            'FALSE' AS exclude_from_scheduling_db,
            'FALSE' AS adjusted_duration,
            ...
            'FALSE' AS appointment_required,
            'FALSE' AS remotely_fulfilled,
            'FALSE' AS scheduled_manually,
