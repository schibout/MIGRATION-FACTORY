...
BEGIN
    ...
    SELECT DISTINCT ON (phl."NUMERO")
        ...
        public.get_default_value('clean_data.ifs_article_maitre', 'nombre_centres_actifs', '0')::bigint AS nombre_centres_actifs,
        public.get_default_value('clean_data.ifs_article_maitre', 'nombre_magasins', '0')::bigint AS nombre_magasins,
        public.get_default_value('clean_data.ifs_article_maitre', 'stock_total_libre', '0')::numeric AS stock_total_libre,
        public.get_default_value('clean_data.ifs_article_maitre', 'stock_total_bloque', '0')::numeric AS stock_total_bloque,
        public.get_default_value('clean_data.ifs_article_maitre', 'stock_total_controle', '0')::numeric AS stock_total_controle,
        public.get_default_value('clean_data.ifs_article_maitre', 'valeur_stock_magasins_total', '0')::numeric AS valeur_stock_magasins_total,
        public.get_default_value('clean_data.ifs_article_maitre', 'actif_dans_centre', 'NON') AS actif_dans_centre,
        public.get_default_value('clean_data.ifs_article_maitre', 'actif_commercial', 'NON') AS actif_commercial,
        public.get_default_value('clean_data.ifs_article_maitre', 'actif_evaluation', 'NON') AS actif_evaluation,
        public.get_default_value('clean_data.ifs_article_maitre', 'actif_achat', 'NON') AS actif_achat,
        public.get_default_value('clean_data.ifs_article_maitre', 'avec_stock', 'NON') AS avec_stock,
        phl."STATUT" AS statut_utilisation,
        public.get_default_value('clean_data.ifs_article_maitre', 'langue', 'FR') AS langue,
